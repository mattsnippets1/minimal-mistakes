...
![Second cam settings]({{site.url}}/assets/images/second-cam-settings.PNG){: .align-center}
*Second cam settings*
{: .text-center}
...
![Crouch controller in action]({{site.url}}/assets/images/crouch-controller.gif){: .align-center}
